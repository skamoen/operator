...
public class ProcessenLevel1FailedLayer extends CCLayer {
	CCInstructionLayer overlay = new CCInstructionLayer();

	public static CCScene scene() {
		CCScene scene = CCScene.node();
		CCLayer layer = new ProcessenLevel1FailedLayer();
	...
	protected ProcessenLevel1FailedLayer() {
		CCColorLayer gameLayer = CCColorLayer.node(ccColor4B.ccc4(255, 255, 255, 255));

		overlay.setUpWithTitle("Jammer!", "", "Opnieuw", "ProcessenLevel1Failed");
		addChild(gameLayer);
